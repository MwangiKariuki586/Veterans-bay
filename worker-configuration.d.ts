/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.api.jsonc` (hash: 25119623e9f8e488eec254ecb70e0fd7)
...
interface __BaseEnv_Env {
	...
	WEB_ORIGIN: "https://veterans-bay-web-preview.mwangialex268.workers.dev" | "http://localhost:3000";
	DATABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "PUBLIC_REGISTRATION_ENABLED" | "WEB_ORIGIN" | "DATABASE_URL" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "CLOUDINARY_CLOUD_NAME" | "CLOUDINARY_API_KEY" | "CLOUDINARY_API_SECRET">> {}
}
