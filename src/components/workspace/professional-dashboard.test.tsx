...
const data: ProfessionalDashboardData = {
  ...
  summary: { newEnquiries: 5, urgentEnquiries: 3, quotationsAwaitingDecision: 3, expiringQuotations: 1, jobsToday: 4, jobsNeedingCheckIn: 1, jobsInProgress: 2, upcomingBookings: 4, outstandingInvoices: 2, overdueInvoices: 2, outstandingInvoicesMinor: 2450000, revenueMinor: 8545000, expectedPaymentsMinor: 6120000, averageJobValueMinor: 305200, previousRevenueMinor: 7240000, previousAverageJobValueMinor: 272500, nextInvoiceDueAt: "2026-08-08T00:00:00.000Z" },
  navigationBadges: { enquiries: 5, quotations: 3, invoices: 2, reviews: 12 }, utilityBadges: { notifications: 6, messages: 3 },
  profileVisibility: { score: 92, status: "Excellent", description: "Your profile is highly visible in the marketplace.", nextAction: "Add photos", nextActionHref: "/professional/profile" },
  ...
  schedule: [{ id: "booking-1", reference: "BKG-7854", timeRange: "10:00 AM–12:00 PM", serviceName: "Leak repair", clientName: "Peter Mwangi", location: "Westlands, Nairobi", status: "IN_PROGRESS", assignmentName: "Alex", href: "/professional/bookings/booking-1", action: "Check in" }],
  scheduleSummary: { tomorrowJobs: 3, weekJobs: 12, unassignedToday: 2 },
